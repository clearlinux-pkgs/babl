...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.84.tar.xz
...
%prep
%setup -q -n babl-0.1.84
cd %{_builddir}/babl-0.1.84
pushd ..
cp -a babl-0.1.84 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609267074
...
cp %{_builddir}/babl-0.1.84/COPYING %{buildroot}/usr/share/package-licenses/babl/e7d563f52bf5295e6dba1d67ac23e9f6a160fab9
cp %{_builddir}/babl-0.1.84/docs/COPYING %{buildroot}/usr/share/package-licenses/babl/7181028b2cb15912d89c76ca33b720a3bfb537cc
cp %{_builddir}/babl-0.1.84/docs/COPYING.LESSER %{buildroot}/usr/share/package-licenses/babl/e7d563f52bf5295e6dba1d67ac23e9f6a160fab9
...
/usr/lib64/haswell/libbabl-0.1.so.0.183.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.183.1
