...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.46.tar.bz2
...
%prep
%setup -q -n babl-0.1.46
pushd ..
cp -a babl-0.1.46 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1523398249
export AR=gcc-ar
...
/usr/lib64/haswell/libbabl-0.1.so.0.145.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.145.1
