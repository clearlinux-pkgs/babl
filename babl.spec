...
%prep
%setup -q -n babl-0.1.100
cd %{_builddir}/babl-0.1.100
pushd ..
cp -a babl-0.1.100 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676915462
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libbabl-0.1.so.0.199.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.199.1
