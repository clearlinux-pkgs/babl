...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.98.tar.xz
...
%prep
%setup -q -n babl-0.1.98
cd %{_builddir}/babl-0.1.98
pushd ..
cp -a babl-0.1.98 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668438687
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libbabl-0.1.so.0.197.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.197.1
