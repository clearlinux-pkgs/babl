...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.110.tar.xz
...
%prep
%setup -q -n babl-0.1.110
cd %{_builddir}/babl-0.1.110
pushd ..
cp -a babl-0.1.110 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730125481
...
/V3/usr/lib64/libbabl-0.1.so.0.209.1
...
/usr/lib64/libbabl-0.1.so.0.209.1
