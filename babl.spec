...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.114.tar.xz
...
%prep
%setup -q -n babl-0.1.114
cd %{_builddir}/babl-0.1.114
pushd ..
cp -a babl-0.1.114 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747145958
...
/V3/usr/lib64/libbabl-0.1.so.0.213.1
...
/usr/lib64/libbabl-0.1.so.0.213.1
