...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.58.tar.bz2
...
%prep
%setup -q -n babl-0.1.58
pushd ..
cp -a babl-0.1.58 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1538840875
export AR=gcc-ar
...
cp docs/COPYING %{buildroot}/usr/share/doc/babl/docs_COPYING
...
/usr/lib64/haswell/libbabl-0.1.so.0.157.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.157.1

%files license
%defattr(0644,root,root,0755)
/usr/share/doc/babl/COPYING
/usr/share/doc/babl/docs_COPYING
