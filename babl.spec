...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.52.tar.bz2
...
%prep
%setup -q -n babl-0.1.52
pushd ..
cp -a babl-0.1.52 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1530749467
export AR=gcc-ar
...
/usr/lib64/haswell/libbabl-0.1.so.0.151.1
