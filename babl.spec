...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.72.tar.xz
...
%prep
%setup -q -n babl-0.1.72
pushd ..
cp -a babl-0.1.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568990759
...
/usr/lib64/haswell/libbabl-0.1.so.0.171.1
