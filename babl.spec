...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.102.tar.xz
...
%prep
%setup -q -n babl-0.1.102
cd %{_builddir}/babl-0.1.102
pushd ..
cp -a babl-0.1.102 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677511353
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libbabl-0.1.so.0.201.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.201.1
