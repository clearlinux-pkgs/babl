...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.26.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1494599555
export AR=gcc-ar
export RANLIB=gcc-ranlib
export NM=gcc-nm
export CFLAGS="$CFLAGS -O3 -falign-functions=32 -ffast-math -ffat-lto-objects -flto -fno-semantic-interposition -ftree-loop-vectorize "
export FCFLAGS="$CFLAGS -O3 -falign-functions=32 -ffast-math -ffat-lto-objects -flto -fno-semantic-interposition -ftree-loop-vectorize "
export FFLAGS="$CFLAGS -O3 -falign-functions=32 -ffast-math -ffat-lto-objects -flto -fno-semantic-interposition -ftree-loop-vectorize "
export CXXFLAGS="$CXXFLAGS -O3 -falign-functions=32 -ffast-math -ffat-lto-objects -flto -fno-semantic-interposition -ftree-loop-vectorize "
...
/usr/lib64/libbabl-0.1.so.0.125.1
