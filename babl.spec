...
Requires: babl-plugins = %{version}-%{release}
...
%package plugins
Summary: plugins components for the babl package.
Group: Default

%description plugins
plugins components for the babl package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565195168
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain -Denable-sse4_1=True -Denable-avx2=True  builddir
ninja -v -C builddir
...
/usr/lib/libbabl-0.1.so.0.169.1
