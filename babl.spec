...
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.96.tar.xz
...
%prep
%setup -q -n babl-0.1.96
cd %{_builddir}/babl-0.1.96
pushd ..
cp -a babl-0.1.96 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661273543
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libbabl-0.1.so.0.195.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.195.1
