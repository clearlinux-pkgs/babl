...
Version  : 0.1.32
Release  : 10
URL      : https://download.gimp.org/pub/babl/0.1/babl-0.1.32.tar.bz2
Source0  : https://download.gimp.org/pub/babl/0.1/babl-0.1.32.tar.bz2
...
%prep
%setup -q -n babl-0.1.32
pushd ..
cp -a babl-0.1.32 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1507074749
export AR=gcc-ar
...
/usr/lib64/haswell/libbabl-0.1.so.0.131.1
/usr/lib64/libbabl-0.1.so.0
/usr/lib64/libbabl-0.1.so.0.131.1
